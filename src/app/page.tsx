        ...
        <main className="relative h-screen justify-center px-5 py-5">
              ...
              <div className="relative z-10 flex h-full max-w-full flex-col px-5 py-6 bg-[#f5ce79] rounded-2xl">
                <header className="flex items-center justify-between gap-4">
                  ...
                  <div className="text-lg text-white/70 font-cute">for <span className="text-white font-cute">{CONFIG.personName}</span></div>
                </header>
                  ...
                  <div className="flex flex-col gap-10 justify-center items-center h-full">
                    ...
                    className="mt-8">
                      <img
                        src="/button.gif"
                        alt="cute gif"
                        className="w-full h-auto scale-50 focus:shadow-amber-300 cursor-pointer"
                      />
                    </button>
                  </div>
                </div>
